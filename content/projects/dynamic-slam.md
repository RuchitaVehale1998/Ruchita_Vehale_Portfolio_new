...
summary: "Real-time SLAM that filters dynamic objects to prevent map corruption, enabling reliable localisation in real-world environments with people and vehicles."
category: "SLAM"
filter: ["slam", "ml", "cv"]
featured: true
weight: 1
